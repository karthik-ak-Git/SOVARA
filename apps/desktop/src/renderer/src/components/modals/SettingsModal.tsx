...
export function SettingsModal({
  ...
  const handleCheckUpdates = useCallback(async () => {
    ...
    try {
      ...
      setUpdateResult({
        status: 'error',
        current: appSettings?.version ?? appInfo?.version ?? '1.1.4',
        latest: null,
                ...
                <div className="settings-modal-card">
                  <div className="settings-modal-row">
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                      <span className="settings-info-chip">{appInfo?.version ?? appSettings?.version ?? '1.1.4'}</span>
              ...
              <div className="settings-modal-group" style={{ marginTop: 20 }}>
                ...
                <div className="settings-modal-card">
                  <div className="settings-modal-row">
                    ...
                    <span className="settings-info-chip">{appInfo?.version ?? '1.1.4'}</span>
                  </div>
                  <div className="settings-modal-row">
                    <div className="settings-modal-row-info">
