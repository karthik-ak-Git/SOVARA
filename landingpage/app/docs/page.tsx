      ...
      <main className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="flex flex-col gap-3">
          ...
          <p className="max-w-2xl text-sm leading-relaxed text-muted-foreground">
            ...
            operational behavior of SOVARA 1.1.4.
          </p>
        </div>
        ...
        <div className="mt-10 grid grid-cols-1 gap-10 lg:grid-cols-[14rem_1fr]">
          ...
          <div className="min-w-0 border-t border-border/60 lg:border-t-0">
            <DocSection id="overview" title="Overview">
              <p>
                SOVARA is a Windows desktop workbench (version 1.1.4)
            ...
            <DocSection id="deployment" title="Deployment">
              <p>
                SOVARA is packaged as a Windows .exe (Sovara-Setup-1.1.4-x64.exe). Building locally
